...
buff_list[0] = buffer_create(max_tex_size * max_tex_size * 16, buffer_fixed, 1);
buffer_get_surface(buff_list[0], tex_list[0], 0, 0, 0);
print(buffer_get_size(buff_list[0]));
//sprite_create_from_surface(tex_list[0],0,0,max_tex_size,max_tex_size,false,false,0,0);
