if (can_draw) {
	if (growth < 1) {
		...
		var _mat = matrix_build(real_x, real_y, real_z-0.1, 0, 0, yaw, _trunk_scale, _trunk_scale, _trunk_scale);
		...
		var _mat = matrix_build(real_x, real_y, real_z-0.1, 0, 0, yaw, 1, 1, 1);
		matrix_set(matrix_world,_mat);
